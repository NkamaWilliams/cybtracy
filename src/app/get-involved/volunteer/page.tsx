        ...
        <div className="group">
          ...
          <div className="input-group">
            ...
            <input
              ...
              name="picture"
              type="file"
              accept="image/png, image/jpg, image/heif, image/heic, image/tiff, image/gif, image/webp"
              required
            />
          </div>
        </div>
        ...
        <div className="group">
          <div className="input-group">
            <label htmlFor="reason">
              Why would you like to Volunteer with Cybtracy *{" "}
            </label>
            <textarea
              id="reason"
              name="reason"
              title="Reason for volunteering"
              required
            />
          </div>
          ...
          <div className="input-group">
            <label htmlFor="expectations">
              What are your expectations from Cybtracy *{" "}
            </label>
            <textarea
              id="expectations"
              name="expectations"
              title="Expectations from us"
              required
            />
          </div>
        </div>
