  ...
  return (
    <footer className="home-footer">
      <div className="home-footer-logo">
        <Image
          src={FooterLogo}
          alt="Cybtracy Footer Image"
          width={220}
          quality={100}
        />
      </div>
      <div className="footer-elements">
        <span className="footer-elements-group">
          <div className="quick-links">
            ...
            <div className="quick-links-container">
              ...
              <Link className="link" href="/about/team">
                The Team
              </Link>
              <Link className="link" href="/get-involved/partnership">
                Get Involved
              </Link>
          ...
          <ul>
            <li>
              ...
              <Link className="link" href="mailto:Cybtracy@gmail.com">
                Cybtracy@gmail.com
              </Link>
            </li>
            <li>
            ...
            <li>
              <Image src={MapIcon} alt="Email Icon" />
              <span>124, Ahmadu Bello way, UNILAG, Lagos, Nigeria.</span>
            </li>
          </ul>
        </span>
