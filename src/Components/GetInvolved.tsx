...
export default function GetInvolved({ title }: { title: string }) {
  const [state, setState] = useState(title);

  const cards = [
    {
      image: "/images/png/icon-gift.png",
      name: "Donation",
      href: "/get-involved/donation",
    },
    {
      image: "/images/png/icon-globe.png",
      name: "Partnership",
      href: "/get-involved/partnership",
    },
    {
      image: "/images/png/icon-volunteer.png",
      name: "Volunteer",
    ...
    <div className="main">
      ...
      <div className="cards">
        {cards.map((card) =>
          state == card.name ? (
            <Link href={card.href}>
              <ActiveCard src={card.image} name={card.name} />
            </Link>
          ) : (
            <Link href={card.href}>
