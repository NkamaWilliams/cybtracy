  ...
  return (
    <section className="whoweare-section">
      <div>
        ...
        <Image
          src={WhoweareBg}
          className="slider-background whoweare-bg"
          alt="Background"
          width={560}
          quality={100}
        />
      ...
      <div className="primary-intro">
        ...
        <p className="header-text">
          ...
          functional literacy by bridging the gap between underserved students,
          and their access to digital literacy in Nigeria.
        </p>
