    ...
    <section className="workstream">
      <div className="workstream-intro">
        ...
        <p className="header-text">
          We seek to impact students with forward-thinking digital skills to a
          point where they can come up with solutions to problems on their own,
          and communicate it digitally.
        </p>
        ...
        <div className="workstream-card-wrapper workstream-card-first">
          <div className="workstream-card">
            <div>
              ...
              <p>
                Our mission is to give underserved children the fundamental
                digital literacy skills they need through sustainability to get
                started and thrive in the present and future digital economies.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="workstream-card-wrapper workstream-card-third">
          <div className="workstream-card">
            <div>
              ...
              <p>
                In addition to introducing them to the digital world, we also
                teach the kids how to stay safe online by teaching them the dos
                and don'ts of using the internet as youngsters.
              </p>
            </div>
          </div>
        </div>
